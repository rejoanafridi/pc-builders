  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        <div>
          <div className="text-orange-600 dark:text-orange-700 text-3xl font-bold">
           PC - Builder
          </div>
      ...
      <p className="text-md text-orange-600  font-bold">
        &copy; 2023. Rejoan Islam. All rights reserved.
      </p>
    </div>
  </footer>
  )
